let Jokes = [`37 Is it true that cannibals don't eat clowns because they taste funny?`,

    `38 What kind of pig can you ignore at a party ? A wild bore.`,

    `39 What kind of murderer has fiber ? A cereal killer.`,

    `44 A man walking down the streets sees another man with a very big dog.One man says to the other, "Does your dog bite", the man replies "No my dog doesn't" The man pats the dog and has his hand bitten off, "I thought you said your dog didn't bite" said the injured man. "Thats not my dog", replied the other.`,

    `45 Q: What's the difference between a shoping trolley and a University vice chancellor? A: You fill them both up with as much food and alcohol you can, but it's only the shopping trolley that has a mind of its own.`,

    `46 Q.How do you catch a polar bear ?`,
    ...
    `49 Three budgies in a cage, one on the top perch, one on the middle and one on the bottom perch.`,

    `Which Budgie owns the cage ?`,

    `    The one on the bottom perch, the other two are on higher perches.`,

    `50 what do you call a fly with no wings ? a walk.`,

    ` `,

    `51 What do you call a teacher with no arms, no legs, and no body ? The Head...`,
    ...
    `54 An 8 - year - old girl went to her dad, who was working in the yard.She asked him, "Daddy, what is sex?"`,
    ...
    `57 Two cannibals are sitting around eating a clown.One clown says to the other, "Does`,

    `this taste funny to you ? "`,

    `58 A piece of straight, clean string goes into a bar and orders a gin and tonic.The barman serves the drink, the string downs it and walks out.Ten minutes later a dirty, twisted, ragged piece of string walks into the bar. "Here - are you that piece of string that was here ten minutes ago?" asks the barman - "No" replies the string "I'm a frayed knot"`,

    `59 there are these two sausages sizzling in a frying pan.the one turns to the other and says "gees, it's hot in here" and the second one turns around and goes "AAAAH!, a talking sausage".`,

    `60 Q - what did the grape say when the elephant trod on it ? A - Nothing, it just gave a little wine.`,

    `61 A man walks into a bar and is about to order a drink when he notices Van Gogh playing the fruit machine.He calls over, "Hey, Van Gogh! Want a drink?" and Van Gogh replies, "No thanks. I've got one 'ere."`,

    `62 There were two cows in a field.One said "moo", the other one said "I was going to say that!"`,

    `64 What did the landlord say as he threw Shakespeare out of his pub ? "You're Bard!"`,

    `65 A three legged dog walks into a Saloon in the Wild West, the barman asks him what he wants.`,

    `The dog replies "I'm looking fo the man that shot my paw"`,

    `66 Two owls are playing in the final of the Owl Pool Championship.It comes down to the last frame.One of the owls is just about to play his shot, when his wing`,
    ...
    `67 An atom walks into a bar and asks the bartender if he's seen his missing electron. "Are you sure she's missing", asks the bartender.`,

    `"I'm positive", replies the atom.`,

    `(this is definitely a joke for science - minded people only)`,

    `    68 Patient: "Doctor I keep hearing "The green, green grass of home" in my head. Doctor : "That's called the Tom Jones Syndrome"`,
    ...
    `75 A mushroom walks into a bar.The bartender says to the mushroom. "Hey we don't`,

    `serve your kind here." The mushroom says "why not I'm a fun guy"`,

    `76 What did the mayonnaise say to the refrigerator ?`,
    ...
    `79 - How long did Cain hate his brother ? -?`,

    `    - As long as he was able...`,

    `80 A grad student, a post - doc, and a professor are walking through a city park and they find an antique oil lamp.They rub it and a Genie comes out in a puff of smoke.`,
    ...
    `81 A penguin walks into a store and asks the teller, "Do you have any grapes?"`,
    ...
    `83 A man goes into the doctor with a penguin on his head.`,

    `The doctor says "What can I do for you?" and the penguin says "well doc, it started as this growth on my foot..."`,

    `84 A man goes to the doctor and says "Doctor, it hurts when I do this", and raises his arm. "Well, don't do it then", says the doctor.`,

    `86 Q: Did you hear about the Ice Cream Sales man that was found dead in his store covered in chocolate sauce and syrup ?`,
    ...
    `92 A man goes to the vet about his dog's fleas. The vet says "I'm sorry, I'll have to put this`,

    `dog down". The man is incredulous and asks why, and the vet says "because he is far too heavy."`,

    `93 An Englishman, an Irishman and a scotsman walk into a bar, the barman asks, " Is this a joke?"`,

    `94 A guy goes to the Doctors and he says "Doctor, I'm really worried about my brother, he thinks he's a Hen!"`,

    `The Doctor says "well have you taken him to see a psychiatrist?", and the guy says "Don't be stupid, we need the eggs!"`,

    `95 A group of Chess enthusiasts were kicked out of a hotel reception for discussing their winning games.The manager can't stand chess nuts boasting in an open foyer.`,

    `96 A brain and a pair of jumpleads walks into a bar.The brain orders two pints from the barman but the barman refuses to serve him.When asked why, the barman replies " Well you're clearly out of your head, and your friend there looks as if he's about to start something"`,

    `97 The police arrested two men, one for drinking battery acid and the other for eating fire crackers.They charged one and let the other one off.`,

    `98 A man went to a horse breeder and said, I want that horse.The breeder said that horse aint looking so good, but the man still wanted to buy it, so he did.The next day he came back with the horse and said, you sold me a blind horse, the breeder replied I told you that horse aint looking so good`,

    `99 Two hikers were walking through the woods when they noticed a bear charging towards them in the distance.The first hiker removed his trail boots and began to lace up his`,
    ...
    `100 Before you criticize someone, walk a mile in their shoes.Then when you do criticize them, you'll be a mile away and have their shoes.`,

    `101 A man on a business trip is staying in a high - rise hotel with a bar on the top floor.After checking in and seeing his room, he decides to go upstairs.There's only one other patron in the bar. The businessman orders a drink and then watches in surprise as the other patron quickly eats an orange, chugs his beer, and jumps out the window.`,
    ...
    `102 How many surrealists does it take to change a lightbulb ? Two, one to do it, and another to hold the fish.`,

    `103 As a funeral train passes by a golf course, a golfer on one of the greens stops, stands at attention with hat held over his heart as the hearse goes by.Then he goes back to lining up his putt.His playing partner remarks how that was the nicest gesture he'd ever seen, to show such respect for the dead. The first`,

    `golfer sinks his putt and says, "Well, she was a good wife for sixteen years."`,

    `104 A woman has twin boys and gives them up for adoption.One goes to a family in Egypt, and is named "Amahl." The other goes to a family in Spain and is named "Juan." Years later, Juan sends a picture of himself to his birth mom.Upon receiving the picture, she tells her husband that she wishes she also had a picture of Amahl.Her husband responds, "But they are identical twins. If you've seen Juan, you've seen Amahl.`,

    `105 What do you call a boomerang that doesn't come back? A stick.`,

    `106 Man walking down the street meets a friend who has a lobster tucked under his arm. "Are you taking that lobster home to dinner?" he asks. "No," says friend, "he's had his dinner and now I'm taking him to the pictures".`,

    `107 A man is sat at home watching T.V.when he hears a knock at the door.The man gets up and answers the door, to his astonishment there is a snail at the door.The snail says "can i sell you some double glazing." To which the man replies "no" and kicks him down the street.Two weeks later there is another knock at the door.The man answers it and it is the snail again.The snail then say "what did you do that for then."`,

    `108 Patient: "Doctor, Doctor I think I'm a pair of curtains." Doctor: "Pull yourself together man."`,

    `109 Patient: Dr, Dr - I can't get this song out of my head and it's driving me mad.I can't stop humming "It's Good to Touch the Green Green Grass of Home"`,
    ...
    `110 Extra strong mint and Mars bar are having a drink in the pub.Extra strong mint says to Mars Bar`, `I'm the hardest mint in town me! No-one\'s harder than me!\'. With that, the bar doors swing open and in walks a Halls mint. Mars bar turns around and extra strong mint is quivering under the table. Mars bar says, "Hang on a minute, I thought you were the hardest mint in town ? !'.Extra strong mint says, "I might be hard, but he's menthal!"`,

    `111 Q.Why do cows have bells A.Because there horns dont work`,

    `112 Three American Indian women in the wild west are about to give birth.One is lying on a buffalo skin; one is lying on a moose skin; and one is lying on a hippopotamus skin.The first woman gives birth to a boy.The second gives birth to a girl.And the third gives birth to a boy and a girl.And this proves. . .the squaw of the hide of the hippopotamus is equal to the sum of the squaws of the other two hides!`,

    `113 Guy walks into the doctor's with a strawberry growing out of his head. Doctor says 'I can give you some cream for that'.`,

    `114 A man goes to a diner.On the menu it says, "Breakfast Served Anytime" so, when the waitress comes he orders French Toast during the Renaissance!`,

    `115 Q: What happens to Composers when they die.A: They decompose`,

    `116 2 atoms were talking, 1 atom said to the other "why are you crying?" the atom replied "I've lost an electron", the first atom said "are you sure?", "yes" replied the other "I'm positive!"`,

    `117 Two men jump out of a plane.One is holding a Budgerigar, the other is holding a Parrot and a shot - gun.As they fall away from the plane the man holding the budgie lets it go.A moment later the man with the Parrot lets go of his bird and takes a lame shot at it with the shotgun.`,
    ...
    `118 I drunk driver is stop for heading the wrong way on a one - way street.The police officer asked the driver didn't you see the arrows.`,
    ...
    `121 a man walks into a shop and says "i'd like to buy a wasp, please." the shopkeeper replies "i'm sorry, sir, we don't sell wasps."`,

    `"but," says the man "you have one in the window."`,

    `122 A white horse walked into a pub and ordered a lager.The landlord put the drink on the bar and said 'We've got a whisky named after you'. The horse replied 'what, Eric ? '.`,

    `123 While robbing a home, a burglar hears someone say, "Jesus is watching you." To his relief, he realizes it is just a parrot mimicking something it had heard.`,
    ...
    `124 How many psychiatrists does it take to change a light bulb ? Only one, but the light bulb's got to want to change.`,

    `125 Where can you find a Mozambique.On a mozam - bird!`,

    `126 Q: What's brown and sticky? A: A stick.`,

    `127 A man gets knocked down by a truck.A guy says to him are you comfortable.He says I make a living!`,
    ...
    `130 What do you call a cow in a paddock with only two right legs... Lean Beef`,
    ...
    `141 Why did Ludwig v.Beethoven kill his two ducks ? - They wouldn't stop saying "Bach`,

    `bach" all the time..`,

    `142 What is green and if it were to fall from a tree would kill you ? A snooker table`,
    ...
    `155 For a laugh three french soldiers put mustard in their ears from then on they are called`,

    `the three mustardears!!!`,

    `156 A blonde girl's husband buys her a mobile phone. She takes it out and he decides to test it out. He phones her and she answers it.`,

    `"It's very good," she says, "but how did you know I was at the hairdressers?"`,

    `157 A man walks into a bar and orders a pint.Then he hears little voices saying things like 'Oooh, you look really nice' and 'That haircut really suits you'.He tells the barman about it who says 'Just ignore it, it's the peanuts, they're complimentary'.`,

    `195 AN ardvark walks into a bar and the bartender says why the long face.`,
    ...
    `Q.Why did the second koala fall out of the tree ? A.Because it was holding on to the first koala.Q.Why did the third koala fall out of the tree ? A.Because he thought it was a game.`,

    `    Q.Why did the little boy fall off his bike ? A.Because he was hit by three koalas.`,

    `198 A horse walks into a bar, the bartender turns & asks the horse whats with the long face.`,

    `199 An Englishman, an Australian and an American walk into a bar.The barman asks them "is this a joke?"`,

    `200 A man put on a clean pair of socks every day of the week.By Friday he could hardly get his shoes on.`,

    `201 How many psychiatrists does it take to change a light bulb ? Just one-- but the light bulb really has to want to change.`,

    `202 What do you get when you pour boiling water down a rabbit hole ? Hot cross bunnies.`,

    `203 Did you hear about the termite who walked into an all - wooden bar and asked, "Is the bartender here?"`,

    `204 The doctor says to the patient, "You're in excellent health - you'll live to be 90." The patient replies, "But Doctor, I am 90!" The doctore responds, "Well, that's it, then."`,

    `205 there are 3 wives who want to decide what to wear.first one says, my husband has black hair I will wera black dree.second says my husband hair is grey and I will wear a grey dress and the third one gets worried and starts panicking.when asked she tells the other two that her husband is bald so she would have to wear nothing to the party.`,

    `206 What will Postman Pat be called when he retires ? Pat`,

    `207 Why did the monkey fall out of the tree ? answer : he was dead`,

    `208 A pork Pie walks into a Pub and says 'Ill have a pint please', to which the landlord replies - 'sorry we dont serve food'.`,

    `209 A man took his Rottweiler to the vet and said to him, "My dogs cross-eyed. Is there anything you can do for it?"`,
    ...
    `210 George Howard, the man famous for writing the Hokey Polky died last week.They had a horrible time at the funeral parlor, first they put his left leg in....`,

    `211 A man died and his wife phoned the newspaper to place an obituary.She called the obituary department and said, "This is what I want to print: Bernie is dead." The man at the`,
    ...
    `212 Sadie's husband Jake has been slipping in and out of a coma for several months, yet his faithful wife stays by his bedside day and night. One night, Jake comes to and motions for her to come closer. He says, "My Sadie, you have been with me through all the bad times. When I got fired, you were there to support me. When my business failed, you were there. When I got shot, you were by my side. When we lost the house, you gave me support. When my health started failing, you were still by my side. You know what, Sadie?" "What dear?" she asked gently. "I think you're bad luck."`,

    `213 A little boy went up to his father and asked: "Dad, where did all of my intelligence come from?" The father replied: "Well, son, you must have gotten it from your mother, 'cause I still have mine."`,

    `214 Why is the number eight afraid of the number seven ? Because seven ate nine.`,

    `215 A neutron walks into a bar, and says "Give me a beer." The bartender says "Hey! Neutron! For you - no charge!"`,
    ...
    `217 A man driving into town spots a truck broken down on the side of the road.He stops to help.The truck driver says he is on his way to deliver some penguins to the zoo.The truck driver say, "I'll give you some cash if you could take the penguins to the zoo for me." The man agrees.`,
    ...
    `223 Q: How do you catch a unique rabbit ? A : Unique up on it.`,
    ...
    `225 Two sailors are eating biscuits together.One breaks a biscuit and two bugs, one large and one small, jump out and run across the table.The sailor asks his mate, "Now, is it better to eat the big one or the small one?" The other replied, "The answer is simple: you must always choose the lesser of two weevils."`,
    ...
    `Why did the second squirrel fall out of the tree ? It thought it was a game.`,

    `Why did the tree fall over ? It thought it was a squirrel!`,

    `231 A sandwich walks into a bar and orders a beer and the barman says "I'm sorry we don't serve food"`,

    `232 What's brown and sits on a piano bench? Answer: Beethoven's Last Movement`,

    `233 Bob is sitting in a bar next to a guy named Clark.Clark gets his usual and drains it he then turns to Bob and says, "I bet you I can jump of the roof and loat to the ground." Bob says "okay go for it." So clark jumps and floats to the ground.So Bob orders what clark just had and tries to jump and float.So he jumps and SPLAT he hits the ground and dies.Clark walks back in the bar and the barkeep says "You know Superman you're really mean when your drunk!"`,

    `Rimshot!!`,

    `234 Did you hear that they dug up Beethoven's body last week? They found him decomposing.`,
    ...
    `237 Why did the worker get fired from the orange juice factory ? Because he couldn't`,
    ...
    `240 A man walks into a bar and says - "ouch thats hot", It was a BARbeque.`,

    `241 Theres a toilet on a hill.There is a man walking up the hill and a man walking down`,
    ...
    `Q: What is blue and looks like a bucket A: A Red bucket in disguise!`,

    `246 Q: What is gray ? A : A melted penguin!`,

    `247 Q.What's the difference between a buffalo and a bison? A. You can't wash your hands in a buffalo.`,

    `248 Why did the monkey fall out of the tree ? It was dead.`,

    `Why did the squirrel fall out of the tree ?`,

    `    It was stapled to the monkey.`,

    `249 A man driving on a highway is pulled over by a police officer.The officer asks, "Did you know your wife and children fell out of your car a kilometre back?".`,
    ...
    `251 A couple of New Jersey hunters are out in the woods when one of them falls to the ground.He doesn't seem to be breathing, his eyes are rolled back in his head.`,
    ...
    `252 A man walks into a bar and says ouch!!! Get it ?`,

    `    253 baby polar bear asks its dad, 'am i a black bear?' 'no' says dad. 'am i a grizzly bear?' 'no, you're a polar bear.go ask your mother, son.' baby polar bear asks its mum, 'am i a brown bear, or a sun bear ? ' 'no', says mum. 'am i a black bear or a koala bear ? ' 'no, you're a polar bear. why do you ask, son?' 'because i am so cold...!'`,

    `254 A newly ordained priest is nervous about hearing confessions and asks an older priest to observe one of his sessions to give him some tips.After a few minutes of listening, the old priest suggests that they have a word. "Iv'e got a few suggestions,"he says. "Try folding your arms over your chest and rub your chin with one hand."The new priest tries this. "Very good," says his senior. "now try saing things like 'I see','I understand' and 'Yes, go on.'"`,
    ...
    `257 What do you call an aarvark that has been beaten up ? A vark.`,

    `258 What is the difference between a doctor and God ? God doesn't think he is a doctor!`,

    `259 Why did the whale jump out of the water ? To get to the other side.`,

    `260 Q.What did the English policeman say when he came home and found his wife in bed`,

    `with three men ? A. 'Ello. 'Ello. 'Ello!`,

    `261 Man is looking down from a plane as it flies over the Pacific Ocean.He turns to the lady next to him and asks: That island down there.Is it pronounced Hawaii or Havaii ? The woman replies Havaii.The man says: Thank you.The woman replies: You're velcome!`,

    `262 Why did the 'possum cross the road? To get half-way across.`,

    `Why did the chicken cross the road ? To show the 'possum it could be done. Why did the anarchist monkey cross the road? He was stapled to the chicken. Why didn't the skeleton cross the road ? No guts.`,

    `263 A man walks into a restaurant and growls at the maitre d', "Do you serve crabs here?" the maitre d' responds "We serve anyone. Have a seat sir."`,

    `264 In a 3rd grade class Jonny was asked if he knew what a canabil was.He said to the teacher "no sir" "Well, if you ate your parents what would you be?" Jonny, s teacher asked him and Jonny said "An orphen, sir"`,

    `265 Did you hear about the rooster who stayed awake all night so that he could see where the sun went ?`,
    ...
    `268 The monks were busy in the monastery copying those beaytiful illuminated`,

    `manuscripts that they used to do when one young monk suggested that since they were copying copies perhaps it might be timely to examine the original to make sure that their copies were correct.The Abbot agreed and sent the monk down into the basement of the monastery to find and examine the original.The young monk was away for some time and finally the abbot went to find him.When he did he found himmin tears and asked him what was wrong.Through his tears the monk blurted out "The word was celebrate!"`,

    `269 Learn the rules so you know how to break them properly.`,

    `270 If you never can make things work from the first try, skydiving is not for you.`,

    `271 I was getting forgetful so I went to the neighbors and aske the husband what is the`,

    `name of your mental doctor that you have been braging about.He aske me what flower has a long steam with thorns.I said a rose.He said thank you, thank you, hey Rose what is the name of my memory doctor.`,

    `272 Never wrestle with a pig: You both get all dirty, and the pig likes it.`,

    `273 I have seen the truth and it makes no sense.`,

    `274 A man ran into the house breathless and he said to his wife, "Honey, you should be so`,

    `proud of me, I just saved $1.50 by not taking the bus, but I chased it all the way home - The wife replied, "You want a medal for that?-You should have chased a cab and saved yourself 15!`,
    ...
    `280 Did you hear about the maniac riding on the subways chopping peoples arms off ?`,

    `    The police caught him and charged him with armed robbery!`,

    `281 A biology student had to write a computer program, but he had troubles to make it work.He asked his roommate, who was a computer science major, to look at his programm and tell him where the error is.The computer`,
    ...
    `284 Well, you see, there are basically three kinds of people in the world.Those who can count and those that can't.`,

    `285 - Can you swim ?`,

    `    - Some times.`,

    `- What do you mean by "some times" ? - Only when I'm in the water.`,

    `286 A man walks into a psychiatrist's office dressed only in saran wrap. The psychologist takes one look at him and says, "I can clearly see you're nuts."`,

    `287 Why did the monkey fall out of the tree ? He was dead.`,

    `Why did the second monkey fall out of the tree ? He was stapled to the first monkey.`,
    ...
    `289 Why does a golfer bring two pairs of pants when he plays golf ? A Incase he gets a hole in one.`,
    ...
    `293 How do you hide an elephant in a cherry tree ? You paint its toenails red!`,

    `294 What is read white and black all over ? A used newspaper!`,

    `295 Did you hear about the two atennae that got married ? The wedding wasn't very good,`,
    ...
    `306 Two not so bright people walking along one day.One says 'Horse tracks!', the other`,

    `disagrees, 'Rabbit tracks I think' just before the train hit them!`,

    `307 Whats ET short for? Because he's got little legs!`,

    `308 a bear walks into a bar and says "Can I have a pint of lager and................................................a`,

    `packet of crisps please ? "`,

    `the barman says "Why the big pause"`,

    `309 Did you read about the midget clarivoyant who escaped from jail ? The headline said "small medium at large."`,

    `310 How many psychiatrists does it take to change a lightbulb ? Only one, but the lightbulb's gonna want to change.`,
    ...
    `312 There was a husband and his wife sitting next to a drunk in a bar.Suddenly the drunk stands up and yells, "ATTENTION`,
    ...
    `314 What do you call a deer with no eyes ? No idear.`,

    `315 A guy walks in to his psychiatrists office and says" Doc you got to help me, One night I dream I'm a tepee and the next night i dream that i am a wigwam." The doctor say's," relax, you're two tents."`,

    `316 What do you call a deer with no eyes and no legs ? Still no idear.`,

    `317 "Doc, I can't stop singing the green green grass of home" "that sounds like Tom Jones syndrome"`,
    ...
    `man on an inflatable lobster.A coast - guard spokesman commented:`,

    `"This sort of thing is all too common these days."'`,

    `319 what has 2 legs and bleeds profusely ? Half a cat`,
    ...
    `323 This chap lives alone and he was feeling a bit lonely, so he goes to the pet shop to get something to keep him company.The pet shop owner suggested an unusual pet, a talking millipede.`,
    ...
    `324 Did you hear about the farmer who won the Nobel Prize for being outstanding in his field ?`,

    `    325 Two drunks are sitting at a bar.`,

    `The first one says, "What's this thing that they call a 'Breathalyzer'?" The second guy says, "It's a bag that can tell how much you drank." The first guy says, "I married one of those things years ago."`,
    ...
    `The publican says, "Here, we've got a drink named after you!" The horse says, "What, Eric?"`,

    `328 What do you call a woman with one leg shorter than the other ? Answer : Ilene`,
    ...
    `330 A truckdriver saw a priest hitchhiking.He thought he would do a good turn and pulled the truck over."No problem, Father! IÌll give you a lift. Climb in the truck." The happy priest climbed into the passenger seat and the truck driver continued down the road.`,

    `Suddenly the truck driver saw a lawyer walking down the road and instinctively he swerved to hit him.But he remembered there was a priest in the truck with him, so at the last minute he swerved back away, narrowly missing the lawyer.But even though he was sure he missed the lawyer he still heard a loud "THUMP".He glanced in his mirrors and when he didnÌt see anything, he turned to the priest and said, "IÌm sorry Father. I almost hit that lawyer." "ThatÌs okay," replied the priest. "I got him with the door!"`,

    `331 Craig David, Shaggy and Britney Spears wre stuck in an elevator when they smelled something like rotten eggs, Craig David said "I'm walkin' away", Shaggy said "it wasn't me" and Britney Spears said "Oops I did it again"`,

    `332 What do you get when you cross an elephant and a kangaroo ? Big holes all over Australia!!`,

    `333 Q.Who won the boxing match between the beaver and the hedgehog ? A.The hedgehog, on points.`,

    `334 A man was walking in the park when he came across a koala.He took it to the polieman and sid "i've found this koala what should i do with him" The policeman said, "take him to the zoo"`,
    ...
    `335 A man finds a genie who says that it will grant him three wishes but that every pollitition in Australia would get double.`,
    ...
    `So he picked the dog up and examined his eyes, then checked his teeth.Finally, he said, "I'm going to have to put him down."`,
    ...
    `349 What do you call a fly with no wings ? A walk!!!`,

    `350 What do you call a child who fries and eats both his parents ? An orphan.`,

    `351 Newspaper Reports say a toilet has been stolen.Policve say they have nothing to go on`,

    `352 Why has Edward Woodward got so many 'D's in his name ? Because otherwise he'd be called Ewar Woowar`,

    `353 Did you hear about the scarecrow that won a Nobel prize ? He was out, standing in his field.`,

    `354 Why did the golfer wear two pairs of trousers ? In case he got a 'hole in one'!`,

    `355 How do you get four elephants into a Mini ? Two in the front, two in the back.`,

    `356 What do you call a mushroom at a disco ? A fun guy`,

    `357 Two atoms are walking down the road.`,

    `One says to the other, "OH NO! I just dropped an electron!" "Are you sure?" asks his friend.`,

    `"Yes" he replies "I'm POSITIVE!"`,

    `358 A bunch of highland cows are standing in a field in Scotland.Which one's on holiday?`,

    `...The one with the wee calf!`,

    `359 - Knock knock. - Who's there?`,
    ...
    `360 Two pieces of tarmac go into a pub and boast to the barman about how hard they are, "We're motorway us."`,
    ...
    `361 A long time ago, there were 3 little bears.....now there's lots of them`,

    `362 What is black and white and eats like a horse ?`,

    `    A Zebra`,

    `363 There were two cows in a field.One said "moo", the other one said "I was going to say that!"`,
    ...
    `368 There was a teddy bear who went to work on a building site.On his first day he went off for lunch and left his tools behind.When he came back he noticed that his pick was missing.When he told the foreman the foreman said "Didn't you know today's the day the teddy bears get their picks nicked"!`,

    `369 A man goes to the doctor and says 'Doctor, there's a piece of lettuce sticking out of my bottom'. The doctor asks him to drop his trousers and examines him. The man asks 'Is it serious, doctor ? ' and the doctor replies 'I'm sorry to tell you but this is just the tip of the iceberg'.`,

    `370 what do u call thieves on a washing line ? ans : knickers`,

    `371 Did you hear about the man who drowned in a bowl of muesli ? He was pulled under by a strong currant!`,

    `372 A young girl is walking along the river and comes across a religious gathering where the minister is baptizing members of his flock.The minister asks the girl if she has found Jesus.ÏNo, Ó she says.Whereupon the minister pushes her underwater, pulls her back up, and repeats, ÏHave you found Jesus ? Ó ÏNo, Ó she says, and is dunked back in the water and again asked, ÏHave you found Jesus ? Ó ÏNo!, Ó she says in exasperation, ÏAre you sure this is where he fell in? Ó`,
    ...
    `381 A polar bear goes into a bar and says to the barman "Could I have a pint of beer and ................................................ a packet of crisps please?".The barman says "Certainly - what's with the enormous paws (pause)?"`,
    ...
    `389 A man walks into a pub, goes up to the bar "Pint of best" he says to the bar man.Whilst waiting for his drink he notices that Vincent Van Gogh is sitting at one of the tables He goes up to him and says`,
    ...
    `401 Q.What did the monk say when returning to his monestary after a trip around the world ? A.The world is my cloister.`,
    ...
    `When it's served, he asks how much it will be. "For you," the bartender answers, "no charge."`,
    ...
    `407 A turtle was walking down an alley in New York when he was mugged by a gang of snails.A police detective came to investigate and asked the turtle if he`,

    `could explain what happened.The turtle looked at the detective with a confused`,
    ...
    `So of course I chased them away, but they kept on coming, and then this old man wonders over in my direction.He's got an ice-cream, and two gulls eating it. And he says: "You'll never stop them, so do what everyone else is doing: relax, enjoy yourself, and let the gulls have the ice-cream....."`,
    ...
    `412 Rene Descarte walks into a bar.Bartender says, "have a beer?" Descarte says, "I think...not..."`,

    `and disappears.`,

    `413 why did the mouse squeak ? 'cos it needed oiling`,

    `414 What do you get when you cross an elephant with a rhino ?`,
    ...
    `417 I've heard that cardiovascular exercise can prolong life. Is this true? Your heart is only good for so many beats, and that's it.Everything`,

    `wears out eventually.Speeding up your heart will not make you live longer; that's like saying you can extend the life of your car by driving`,
    ...
    `420 Inventions today: it's reported that a new kind of pillowcase has been invented, made out of cordurouy.`,
    ...
    `423 Why did the chicken cross the road ? To get to the rooster on the other side.`,

    `424 Two Bears in an airing cupboard, which one is in the army ? The one on the tank!!`,
    ...
    `426 A doctor says to his patient, 'I have bad news and worse news'. 'Oh dear, what's the bad news ? ' asks the patient.`,
    ...
    `429 Man1 "My wife's gone to the West Indies." Man2 "Jamaica?"`,

    `Man1 "No she went of her own accord":`,

    `430 How do you keep your nose from running ? Teach it to WALK!`,
    ...
    `440 A drunk was standing on a London Street corner shouting "It can't be done! It can't be done!" Just ten, a Bobby aproached him and said: "What can't be done?"`,
    ...
    `444 Mahatma Gandhi, as you know, walked barefoot most of the time, which produced an impressive set of calluses on his feet.He also ate very`,
    ...
    `445 Two shepherds lean on their crooks at the end of a long day and the first asks the second, "So, how's it going?"`,
    ...
    `446 James wanted to start a new hobby, and he decides he's going to learn a new flying sport. So he invites his friends to come and watch.`,
    ...
    `447 He said 'I'm going to chop off the bottom of one of your trouser legs and put it in a library.'`,
    ...
    `451 A man in a hurry taking his 8 - year - old son to school, made a turn at a red light where it was prohibited.`,
    ...
    `454 i went to the doctors the other day and[whilst raising my hand in the air] i say "doctor it hurts when i do this"`,

    `the doctor replies "Well dont do it then"`,

    `455 Some tourists in the Chicago Museum of Natural History were marveling at the dinosaur bones.One of them asked the guard, "Can you tell me how old the dinosaur bones are?"`,
    ...
    `458 One day little Johnny was in his back yard digging a hole.His neighbor, seeing him there, decided to investigate.`,
    ...
    `460 Went to the doctor and he told me i would have to take a pill every day for the rest of my life.`,
    ...
    `481 what is red and stands in the corner ? a naughty strawberry`,

    `482 a group of 99 ostritches is standing around with their heads buried in the sand, an ostritch runs up to join the group, looks around and says, "Hey! Wheredid everyone go?"`,
    ...
    `The duck leaves, but returns the next day, with the same question: "Got any grapes?".The bartender angrily replies: "look, I have already told you twice that we don't have any grapes here. Now get out of the bar before I nail your little webbed feet to the floor!".The duck walks out, but comes back the next day.He asks: "Got any nails?"`,

    `The bartender replies: "No, this isn't a hardware store!".`,

    `Duck says: "Got any grapes?"`,

    `486 Whats the difference between a bison and a buffalo ? You can't wash in a buffalo`,

    `487 There was three tomatoes walking down a street.The daddy tomato and the mammy tomato were way ahead of the baby tomato.The daddy tomato got so annoyed at the baby tomato for being so slow that he turned around real quickly and smacked his hands together and roared "KETCHUP"!!!!`,

    `488 A polar bear goes into a pub and says to the barman: "I'd like a.......................packet of salt and vinegar crisps please." The barman replies, "Sure, but why the big pause?"`,

    `489 A three legged dog walk bursts into a wild west saloon and says "I'm looking for the man who shot my paw"`,

    `490 A grasshopper walks into a bar.The bartender says "hey! we've got a drink named after you!".The grasshopper says "you have a drink named Murray?!"`,
    ...
    `492 A guy is driving down the motorway, knitting.Obviously this is dangerous driving as the driver has no hands on the wheel, so before long the police are catching up with him.One police car drives up alongside the offending vehicle, and motions for him to open his window.`,
    ...
    `494 Who is a penguin's favourite relative. His Aunt Artica!`,
    ...
    `497 Q.What is white and walks through the desert ? A.A herd of yoghurt`,
    ...
    `499 A guy tries to enter a nightclub but is stopped at the door by the bouncer who tells him that he can't get in without wearing a necktie. The guy goes back to his car, looks around but can't find a tie.He sees a set of jumperleads in the back so he puts them around his neck and ties a rough knot.He walks back to the nightclub.When the bouncer sees him he looks him over and says "OK you can go in - but don't start anything"`,

    `500 why did the fly do an old - fashioned dance on the jam jar ? because it said "twist to open`,
    ...
    `503 How do you kill a circus ? Go for the juggler.`,

    `504 A square and a circle walk into a bar.The square says to the circle, "Your round!"`,
    ...
    `507 A guy phones the local hospital and yells "You've gotta send help! My wife's in labour!" The nurse says, "Calm down. Is this her first child?" He replies, "No! This is her husband!"`,
    ...
    `510 Why do deep sea divers jump out of the boat backwards when they want to go into the water ?`,
    ...
    `512 A PROFESSOR WAS GIVING ONE OF HIS LECTURES.IN THE MIDDLE OF HIS LECTURE A`,
    ...
    `513 A mother -in -law sent two ties to her son -in -law.Some weeks later, she was invited for lunch, and so he wore one of them in the hope of pleasing her.The meal was a tense and uncomfortable one, with the Mother -in -law maintaining a stony silence.Finally she spoke. "Alright, what's wrong with the other tie."`,

    `514 What did the orange say to the banana on the street corner ? "Hi"`,

    `515 Wy was 6 afraid of 7 ? Because 7 ate 9.`,

    `516 A family of tortoises went into a cafe for some ice cream.They sat down and were`,

    `about to start when father tortoise said, "I think its going to rain, Junior, will you pop home and fetch my umberella?"So off went Junior for father's umberella,but three days later he still hadn't returned. " I think , dear," said mother tortoise to father tortoise, "that we had better eat Juniors ice cream before it melts." And a voice from the door said, "If you do that I won't go."`,
    ...
    `a police man comes along as she drives off.he calls" hey you can't leave that lying there. she calls back thats not a lion it's a cat.`,

    `525 How do telephones get married ? They just give each other a ring.`,

    `526 An engineer, a physicist, and a mathematician are on a train in Scotland.The engineer`,

    `looks out the window and sees a black sheep.He comments, "Look, they have black sheep in Scotland".Then physicist looks and comments, "From this observation, we can only say there is at least one black sheep in Scotland." The mathematician then looks and comments, "Actually, from this we can only say there is at least one sheep in Scotland that's black on one side."`,

    `527 A proton, neutron, and electron walk into a bar.The proton orders a drink, and asks how much it costs.The bartender says, "five dollars." Next, the electron orders a drink and asks how much it costs.Again the bartender says, "five dollars." Finally the neutron orders a drink and asks how much it costs.The bartender says, "for you, there is no charge."`,
    ...
    `531 A businessman is hurrying home on the motorway after a hard days work when he is`,

    `stopped by a policeman. 'Do you know you were driving 30 mph over the limit?' asks the policeman. 'Eh, actuallly no, officer, it's a big car and it just sort of coasts along. . .you know. . .' 'And what were you planning on doing if you met Mr Fog ? ' demands the policeman. 'Well, ' says the businessman, thinking it best to play along, 'I suppose I'd ease off on Mr accelerator, and switch on Mr headlights and Mr windscreen wipers'.The policeman leans in the window and eyeballs the businessman. 'I asked you what you were planning on doing if you met MIST OR FOG!'`,

    `And threw the book at him.`,

    `532 "You're a high-priced lawyer! If I give you $500, will you answer two questions for me?"`,
    ...
    `535 Q: Why do people say you never judge someone until you've walked a mile in their`,

    `shoes ? A : Because then when you do you'll be a mile away and have their shoes.`,

    `536`,

    `537`,

    `What do you get if you cross a mammal with a reptile ? A Nobel prize Q: What happens if you don't pay your exorsist.A: you get repossesed`,
    ...
    `542 A patient walks into the doctors office and says doctor I have pain anywhere I touch my body with my finger! The doctor says thats unusuall.So he tell her to touch her arm with her finger and she screams in pain.He tells her to touch her foot with her finger she yells in aggony.He tells her to touch her leg with her finger and she screams.The doctor then goes to the patient and says just as as I though your finger is broken!`,

    `543 What's red and invisible? No tomatoes.`,

    `544 "Thats a funny reptile you have whats its name?" "Tiny"`,

    `"Why do you call it Tiny"`,

    `"Because he is My Newt"`,

    `545 Police were called to a Pizza Hut in Leeds at the weekend after the body of a worker was found covered in mushrooms, onions,`,
    ...
    `546 Q:Why does an elephant paint its nails red ? A : so it won't be noticed between the strawberries.`,

    `Does it work ? Well...ever seen an elephant between the strawberries ?`,

    `    547 What is worse than finding a maggot in your apple ? - Finding half a maggot in your apple.`,

    `548 A man is driving down the road when he gets pulled over by a copper.The copper draws a circle on the floor and asks the man to stand in it.While the man stands in the circle, the copper gets out a hammer and smashes the cars headlights.The copper turns around and sees the man laughing! So the copper goes and smahes each of the cars windows.The copper turns around again and sees the man laughing even harder! The frustrated copper then shouts to the man, "What the hell you finding so funny??" The man replies, "Everytime you turned around, i've been jumping in and out of this circle!!`,

    `549 Q: What lies on the bottom of the ocean and quivers ? A : A nervous wreck.`,

    `550 A little babymouse is walking hand in hand together with her mother.Suddenly a bat comes flying in the air.`,

    `The little mouse point's at the bat saying: Look Mammi, an angel.`,

    `551 What do you call a princess who worries all the time ? A warrior princess.`,

    `552 Did you hear about the Buddhist monk who refused to have his mouth frozen when he`,

    `went to the dentist ?`,

    `    He wanted to transcend dental medication.`,

    `553 A man had a dog called minton.One day minton ate two shuttle cocks.When the owner found out he said bad minton!!!!`,

    `554 A guy takes a trip for a short holiday.His wife is on a business trip that is ending the next day and she plans to fly down and meet him.When he arrives at his hotel he sends her a quick message.Unable to find the piece of paper on which he wrote her company e - mail address, he does his best from memory.`,
    ...
    `555 I cut the bottom off one of my trouser legs the other day and sent them to the library.Well theres a turn - up for the books.`,

    `556 Sherlock Holmes and Dr Watson went on a camping trip.After a good meal and a bottle of wine they lay down for the night, and went to sleep.`,
    ...
    `    561 A neutron walks into a bar and orders a drink.When he asks the bartender how much`,

    `he owes him, the bartender says, "For you, it's no charge."`,

    `562 What do you call a Swiss Financier on the Paris Undergound ? A metronome.`,

    `563 Why did the chicken cross the road ? To show the possum that it COULD be done.`,

    `564 Two men are hired to do a job in a building.After the owner explains everything, he leaves.When he returns a while later, he sees one man working diligently and the other man hanging on the ceiling, singing "I'm a chandelier, I'm a chandelier." The owner orders him to come down and get back to work.A while later the owner returns to find the one working diligently and the other back on the ceiling, singing "I'm a chandelier, I'm a chandelier" again.`,
    ...
    `565 A group of dentists decided to set up a new surgery.Since competition in their area was quite fierce, they wanted their new business to have something unique about it.`,
    ...
    `566 A group of astronaughts are on the moon.They've been mining the surface, and have discovered that it really is made of cheese.`,
    ...
    `571 early one morning a gentleman was doing his push up exercises in central park when a drunk came along and tapped him on the shoulder and said "say mister i think your girlfriends gone home"`,
    ...
    `575 An American, an Australian and a Japanese man become stranded on a tropical island.`,
    ...
    `577 Dave: Me and the missus went to the Caribbean this year for our summer holidays.John: Jamaica ?`,

    `    Dave : No, she went of her own accord!`,

    `578 Q: Why do elephants drink ? A : To try and forget`,

    `579 A black man walks into a store with a parot on his shoulder.the clerk ask where he got him from.the parot said, "Africa, there is a whole bunch of them down there."`,

    `580 What do you call a boomerang that doesn't come back? A stick.`,

    `581 What do you call a fly with out wings ? A walk`,

    `582 How do nuns boil water ? They boil the hell out of it.`,

    `583 A male ostrich was chasing two female ostriches.The one female said to the other, "He's starting to gain on us, we better hide!" So, they stopped and stuck their heads in the sand.The male ostrich said, "...Hey, where'd they go?"`,

    `584 A 3 legged dog walks into a bar and says "Who shot my paw?"`,

    `585 A string walks into a bar, and the bartender says "We don't serve strings here".So the`,

    `string goes into another bar, and the bartender says "We don't serve strings here".So the string goes into ANOTHER bar, and the bartender says "We don't serve strings here".`,
    ...
    `586 When NASA first started sending up astronauts, they quickly discovered that ballpoint pens would not work in zero gravity.To combat the problem, NASA scientists spent a decade and $12 billion to develop a pen that writes in zero gravity, upside down, underwater, on almost any surface including glass and at temperatures ranging from below freezing to 300C.The Russians used a pencil.`,

    `587 Descartes walks in to a bar.The bartender ask if he'd like a beer. Descartes replies, "I think not." Then he disapears.`,

    `588 A fish walks into a bar and the bartender says what will it be.The fish replies water!`,

    `589 A depressed horse walks into a bar.The barman asks him, "Why the long face?"`,

    `590 A man goes to a psychiatrist and says, "Doc, you gotta help me. I've been having the`,

    `strangest dreams.Last night I dreamed I was a teepee, and the night before I dreamed I was a wigwam.What do you think it means ? " The doctor pondered a moment and replied, "Well, it sounds like you're two tents."`,
    ...
    `593 A new teacher was trying to make use of her psychology courses.She started her class by saying, "Everyone who thinks they're`,
    ...
    `595 Did you hear about the ship that ran aground carrying a cargo of red paint and black`,

    `paint ? The whole crew was marooned.`,

    `596 How many surrealists does it take to change a light blub ? To get to the other side.`,

    `597 Why didn't the Clam share his candy? Because he was Shellfish`,

    `598 What is the difference between ignorance, apathy, and ambivalence ? I don't know and`,

    `I don't care one way or the other.`,

    `599 A Philosopher and scientist were being chased by a lion.The Scientist looked back and made a swift calculation.Puffing, he said to the philosopher - 'we can't out run it you know' The Philosopher was slightly ahead, he replied 'I am not trying to outrun the lion, I am trying to out run you!`,

    `600 Charles Dickens walks into a bar and orders a Martini.Bartender asks "Olive or Twist?"`,

    `601 Why can't dalmations play hide and seek? Because they are always spotted.`,

    `602 An inebriate enters a restaurant and asks the cashier, "Did you see me come in the door, there?"`,
    ...
    `604 A doctor says to his patient, "Without these treatments, you've got 3 months to live,"`,
    ...
    `605 How do you make a cat go woof ? Pour petrol on it.`,

    `606 A swede(vegetable) walks in to a library and the librarian looks up and says "There's a turnip for the books"`,

    `607 If Sondra Locke married Elliot Ness, divorced him and married Herman Munster, she'd be Sondra Locke Ness Munster.`,

    `608 A guy goes to the doctor and complains he can't stop singing the "Green, Green Grass Of Home".`,
    ...
    `609 "Doctor, I used to think I was a dog, but I reckon I'm cured now-wow-wow!" "I see. How long did you have this complaint?"`,
    ...
    `610 Q: What is big, grey and sings the Blues ? A : Elephant Gerald.`,
    ...
    `613 If I eat three cakes in the morning and three for tea... what will I have / Answer: A tummyache`,

    `614 A pirate walks into a pub.Another patron, having never met a pirate before, wants to know the stories behind the battle scars.He buys the pirate a pint, and strikes up a conversation.`,
    ...
    `622 There's this guy with a wooden eye. He's very sensitive about it, so he doesn't get out`,

    `much.One day, he sees an ad for a dance, and he decides to go.He gets there, and he sees an attractive young lady with a gigantic nose.He thinks to himself "Well, she has that huge nose. Maybe she'll be more accepting of my wooden eye." He walks over to her and says "Would you like to dance?" She replies "Oh! Wouldn't I!" He shouts "Big nose! Big nose!"`,

    `623 Guy is sitting in a bar.A beautiful woman walks in.She's a knock-out and he can't take his eyes off her.She notices him and smiles.She sashays over and sits beside him.She looks into his eyes and tells him, "For $200 I'll do anything you want." He's astounded. "Anything?!", he asks her. "Yes, _anything_!", she replies. He takes out his wallet and slaps $200 on the bar. "Here's $200.Paint my house!"`,

    `624 A man came home from golfing one Saturday a little later than he usually did.His wife asked him why.`,

    `"Bob had a heart attack and died right there on the 9th hole!" he explained.`,
    ...
    `625 someone was walking in street & carrying a rabbit, another one met him & ask: How much does this donkey cost ? the man reply: it is not a donkey it is a rabbit, the another said: I didn't ask you I'm asking the rabbit:))`,
    ...
    `628 A mother put her child to sleep and then went to the kitchen.She then saw her son and`,

    `he asked, "Can I have a glass of water?" The mother gave him a glass and he back upstairs.Minutes later the boy returned asking for a glass again.The mother wondered what could make her child so thirsty and when he came back down asking for another glass of water, the`,
    ...
    `629 What is the leading cause of dry skin ? Towels`,

    `630 A man walks up to the main desk a library and says in a loud commanding voice to the librarian, I'll take two hamburgers, no mayonnaise, and an order of fries. The librarian looks up at him, shocked. Summoning up all the testy authority she can, she says to him, Sir, this is a library!`,
    ...
    `632 "Doctor!" said the patient. "I keep seeing spots before my eyes." The`,

    `physician scratched his head, "Why have you come to me? Have you seen an opthalmologist?" "No," replied the patient, "just spots."`,

    `633 Two televisions walk into a bar and the barman says "sorry, we don't serve your kind in here", and one television turns to the other and says "we're not getting a great reception in here"`,

    `634 Why did the projector blush ? Because it saw the film strip.`,

    `635 Two penguins are sitting in a bathtub.The first one asks the second one to pass him the soap.The second one says, "What do you think I am, a typewriter?"`,

    `636 Why are chickens considered good employees ? Because they work around the cluck.`,

    `637 In a dark night, under a street lantern, someone seeks after a lost key.Another helps`,

    `seeking, and after half an hour on their knees, the other asks: "Are you really sure that you lost your key right at this place?".The one answers: "No, I lost it further down the road, but here the lightning is better!".`,

    `638 A young lad came home after his first day at school was asked by his mother how did he enjoy his first day at school.He told her that the other kids were teasing him.They kept laughing and calling him big head.His mother told him to ignore them.She also told him that there was nothing wrong with his head.She then asked him to go the store and get ten pounds of potatoes.He asked her what could use to carry them in.She replied----use your hat.`,

    `639 Why aren't elephants allowed on the beach? They can't keep their trunks up.`,

    `640 How do you keep an idiot in suspense ? I'll tell you later...`,
    ...
    `646 A man walks into a pub and sees Vincent Van Gogh sitting in the corner. "Fancy a pint Vincent?" he asks`,

    `"No thanks," Van Gogh replies, "I've got one 'ere."`,

    `647 Man walks into a bar and immediately notices two pieces of meat nailed to the ceiling. "What's with the meat?", he asks the barman.`,

    `"Oh, that's just a little competition.", the barman explained. "If you can jump up and catch a piece of meat between your teeth, then you get a free drink.".`,
    ...
    `648 A man goes to the doctors and says 'I have a problem doc, I can't say my 'f's, my 't's or my 'h's.The doctor says 'well you can't say fairer than that'.`,

    `649 Q.What have an orange and a parrott got in commom ? A.Neither of them can drive a tractor.`,

    `650 Two oranges are walking down the road.The one orange says to the other, "So, where do you live then?" and the other replies,`,
    ...
    `652 Why are elephants big, grey and wrinkled ? Because if they were small, white and smooth they would be aspirin.`,

    `653 Did you hear about the man that was walking down the street and turned into a hotel ?`,

    `    654 A frog telephones a psychic hotline and is told: "You are going to meet a beautiful`,

    `young girl who will want to know everything about you." "Great!" says the frog. "Will I meet her at a party ? " "No, " replies the psychic. "Next year, in a biology class."`,

    `655 Q: How many pragmatists does it take to change a lightbulb ? A : One.`,

    `656 A man goes into a pet shop to buy a parrot.The shop owner points to three identical looking parrots on a perch and says:`,
    ...
    `670 How many punk rockers does it take to change a light bulb ? Two, one to change the bulb and one to kick the chair out from underneath him.`,

    `671 Q.What do you give dead bread ? A.A toast - mortem`,

    `672 Two television aeriels met on top of a roof and fell in love, and soon decided to get married.The service was terrible - but the reception was brilliant!`,

    `673 Where does a policeman live ? 999 letsbe avenue.`,

    `674 knock knock who's there?`,
    ...
    `675 What do you call a nun with a washing machine on her head ? Sister Matic`,

    `676 Two elderly gentlemen were talking.One says, "Boy, this new hearing aid I got works great! I can hear everything now." The other one says, "That's wonderful! What kind is it?" "It's a quarter past two."`,

    `677 Q.Why is television called a medium ? A.It is neither rare nor well - done.`,

    `678 A large hole appeared in the High Street this morning.The police are looking into it.`,

    `679 A couple are out touring a house that they want to buy with a realtor when they ask the realtor, "The house is very nice, but is this a quiet neighborhood?"`,
    ...
    `681 If miss universe is not fixed then why are all the winners from earth`,

    `682 Bacon and eggs walks into a bar, and the bartender says "Sorry, we don't serve`,

    `breakfast".`,

    `683 What did one snake say to another ? "Mum, are we supposed to be poisonous?" "No son, why?"`,

    `"Because I just bit my lip!"`,

    `691 A business owner has just moved places and was reopening soon.A friend of his wanted to cocratulate him so he went to the local florist and asked if he could have some flowers delivered to the man.He then asked the florist worker to write something clever to go with the flowers.A few days later the florist receives phone call.It was the boss. "I am sure there was a muck up in your delivery service, my flowers came but it said: Rest In Peace on it" "Well I'm sorry" was the reply "But you think of these mourners at a funeral at the moment with flowers with a card saying: Congratulations on your new place"`,

    `692 what should you do if you get snow in your mouth ? Just grit your teeth!`,

    `693 A husband and wife were having a fine dining experience at their exclusive country club when this stunning young woman comes over to their table, gives the husband a big kiss, says she'll see him later and walks away.`,
    ...
    `696 A monstery falls on hard times so 2 monks decide to open a FISH & CHIP bar.On the first day of opening a woman comes in and sees one of the monks peeling spuds, so she says to him, "You must be the chipmonk", he replies, "No, I'm the friar"!!`,

    `697 Jesus decided to help St.Peter at the Pearly Gates.`,

    `A very old man approached and Jesus asked him, "How have you lived your life?" The old man replied, "I was a carpenter."`,
    ...
    `698 Couple goes to a psychiatrist.Woman says, "Doc, my husband thinks he's a dog. Can you help him?" Shrink says, "Sure, have him lie down on the couch." Woman says, "Oh no. He's not allowed on the couch."`,

    `699 A man walks into a bar with a piece of tar mac under his arm.He says to the bar man " a pint for me and one for the road".`,

    `700 A man was walking in the country and saw a pig with a wooden leg sitting outside a barn.As he was pondering this, the pig's owner came along. The man asked the farmer how the pig got his wooden leg.`,
    ...
    `710 Joan, the town gossip and supervisor of the town's morals, recently accused George, a local man, of being an alcoholic because she saw his pickup truck parked outside the town's only bar.`,
    ...
    `711 There was a lawyer and he was just waking up from anesthesia after surgery, and his wife was sitting by his side.`,
    ...
    `712 Give a man a fish and he will eat for a day.Teach him how to fish and he will sit in a boat and drink beer all day!`,

    `713 "This day holds a lot of meaning for me. It was on this day two years ago that I lost my dear wife and children. I'll never forget that game of cards...."`,

    `    - Anon.`,

    `714 After a trial had been going on for three days, Finley, the man accused of committing the crimes, stood up and approached the judge's bench.`,
    ...
    `715 Our supermarket had a sale on boneless chicken breasts, and a woman I know intended to stock up.At the store, however, she was disappointed to find only a few skimpy prepackaged portions of the poultry, so she complained to the butcher.`,
    ...
    `716 Sean got home in the early hours of the morning after a night at the local pub.He made such a racket hitting into the furniture as he weaved his way through the house, that he woke up the missus.`,
    ...
    `717 A group of kindergarten children were on a class outing to their local police station where they saw pictures, tacked to a bulletin board, of the 10 most wanted men.`,
    ...
    `718 While making his rounds, a doctor points out an X - ray to a group of interns. "As you can see the patient is limping because his left fibula and tibia are radically arched. Michael, what would you do in a case like this?" "Well," said the intern, "I suppose I'd limp too."`,

    `720 A man commits suicide.In one of his pockets, the police find an envelope.Inside the envelope is a note that reads: "What are you looking in here for?"`,

    `721 A worried Mrs.Melchnik sprang to the telephone when it rang and listened with relief to the kindly voice in her ear.`,
    ...
    `729 What you call a snowman with a sun tan ? A puddle!`,

    `730 If atheletes get athelete's foot, what do astronauts get? Missile toe!!`,

    `731 Ted: I had the worst dream last night.I dreamed I ate a 2 - ton marshmellow.Steve: What's wrong with that?`,

    `Ted: When I woke up my pillow was gone`,

    `732 The scene is a butcher's shop Customer: "I'd like a pound of kidleys, please" Butcher: "Surely you mean kidneys, madam" Customer: "I said kidleys, didle I!"`,
    ...
    `736 A man rushes into the doctors and says "Doctor doctor you've got to hep me I think I'm a pair of curtains".The doctor replies "Oh pull yourself together".`,
    ...
    `739 What do you call a chicken in a shellsuit ? An egg!`,

    `740 How is a lawyer different than and angry chicken ? The angry chicken "clucks defiance"!`,

    `741 ME: doctor doctor, I've only got 50 seconds to live! DOCTOR: Just a Minute`,

    `742 A man walks into a butcher's shop and asks the butcher "Have you got a sheep's head ? ". "No", replies the butcher, "it's just the way I part my hair".`,

    `743 why did the blind chicken cross the road ? To get to the birds eye shop!`,

    `744 There were two boys called manners and shut up.Shut up went to the sweet shop and manners went to the fish and chip shop.The shop keeper said to shut up.What's your name and shut up said shut up. The shop keeper said that's not nice where's your manners. In the fish and chip shop said shut up.`,
    ...
    `747 A couple comes up to a wishing well.The guy leans over, makes a wish, and throws in a penny.`,
    ...
    `    "Pack your bags sweetheart, I've just won the lottery, all six numbers!" She says, "Oh wonderful! Should I pack for the beach or the mountains?" He replies, "I don't care...just pack & shove off!"`,
    ...
    `750 Tell a man that there are 400 billion stars, and he'll believe you. Tell him a bench has wet paint, and he has to touch it.`,

    `751 What do you call a man with seagulls flying around his face ? Cliff`,
    ...
    `753 What do you call a women who can juggle with beer ? A.Beertrix`,

    `754 Did you hear about the dyslexic devil worshipper ? Sold his soul to Santa.`,

    `755 A cross and hungry panda went into a bar and, without ordering a drink, demanded a`,

    `bowl of free bar - snacks.The bartender refused:`,

    `"Those snacks are for paying patrons." So the panda grabbed the nearest bowl, gobbled up all the snacks.Then he pulled out a revolver, shot the bartender dead, and stalked out.`,

    `The patrons all asked each other "Who was that masked maurader?" The quiet little guy at the end of the bar calmly answered:`,

    `"That was a panda. He eats shoots and leaves."`,

    `756 What is the difference between a duck ? One of its legs is both the same!`,

    `757 A man went to a pet shop and said "I'd like to buy some wasps please." The shop keeper said, "I'm sorry, we don't sell wasps." "Well I saw three of them in the window!" replied the man.`,

    `758 A bloke handed his mate an octopus that looked to be at death's door, and said "There's the six quid I owe you".`,

    `759 Early morning in december 1968 a journalist calls Lyndon B.Johnson and asks what he most wishes for Christmas.Johnson is desperately trying to make his drowsy brain work.Bedazzled he tries to think of something adequate but not too exaggerated.Next morning The`,
    ...
    `760 One day, a HR woman was hit by a bus and killed.Her soul arrived in heaven and she was met by St.Peter.`,
    ...
    `765 A guy walks into a doctor's office with a strawberry growing out of his head. The doctor says`,

    `"Don't worry - I've got cream for that".`,

    `766 A guy walked into a psychiatrist's office wearing only cling-film underpants.`,

    `The psychiatrist said`,

    `"Well, I can see you're nuts".`,

    `767 How is the new furniture store doing ? Sofa so good!`,
    ...
    `771 Little Johnny is working away furiously in the woodwork room when the teacher enters. "what are you making there, Johnny?" he asks, "a portable" replies Johnny.The teacher looks puzzled, "a portable what?".Johnny replies "I don't know yet Sir, I've only made the handles!"`,
    ...
    `775 why did Jim bring his car into school ? Because he wanted to drive his teacher up the`,

    `wall!!!!`,

    `776 two knights went into a hotel and said to the woman at reception 'i would like a room for two nights!!!!'`,

    `777 A husband and wife are traveling by car from Key West to Boston.After almost twenty - four hours on the road, they're too tired to continue, and they decide to stop for a rest. They stop at a nice hotel and take a room, but they only plan to sleep for four hours and then get back on the road.`,
    ...
    `778 A scientist and a philosopher were being chased by a hungry lion.The scientist made some quick calculations, he said "its no good trying to outrun it, its catching up".The philosopher kept a little ahead and replied " I am not trying to outrun the lion, I am trying to out run you"!`,

    `779 Near dawn in a colony of Vampire bats, all are still hungry but one hangs there with blood on its face.They all pester and nag "well it's alright for some! why don't you share this great feeding place with the rest of us?!" only to get told "Really, you dob't wadt to gnow" which does nothing to calm them down so finally they are led off along the hedge and over the pastures to a big tree in the middle of a field, where usually there are cattle to feed from.Flying round and round the tree they are again getting angry as there are no cattle to be seen, but the bloody - nosed bat just says "You all thee dis tree dob't you, well I dibn't!".`,

    `780 A man walks into a pub where everybody else is having coffee with cream. "I would like a coffee. No cream on it."`,

    `"Sorry, we ran out of cream. Could it be with no milk?"`,

    `781 What do you call a person who used to like tractors a lot ? An ex - tractor fan!!`,
    ...
    `783 Two farmers are standing at a fence talking.Farmer 1: Do your cows smoke cigarettes ???`,

    `    Farmer 2: No, of course not!! Farmer 1: Then your barn is on fire.`,

    `784 why did the skeleton cross the road ? to get to the body shop.`,

    `785 A man on holiday in India soon finds out about a monastery, high in the hills,`,

    `    the only way to get to it is to take a half hour ride in a basket, being hoisted`,

    `up the cliff face.The man decides this would be an adventurous thing to do, so he goes and asks the monk at the bottom of the cliff weather he can get a lift`,

    `up, the monk agrees and they begin the journey.About halfway through, the man notices that the rope that basket is hoisted up on is very frayed, fearful,`,
    ...
    `787 PATIENT: Doctor, doctor.I've come up in spots like cherries on a cake.`,
    ...
    `790 A frog goes into a bank walks up to the teller whose name is Pat Wack.He says "Good`,

    `Morning Miss Wack, my name is Kermit Jagger and I want to take out a loan for $10, 000." She looks at him curiously "Do you have any collateral ? " He holds up a pink china elephant "This is my collateral". "Just a moment please" she says "I'll have to see the Manager". She goes into the Manager's office and says "There's a frog outside whose name is Kermit Jagger - he wants a loan of $10,000 and all he can raise as collateral is a pink china elephant. Surprised, he looks at her and replies "Nicknack Patty Wack give the frog a loan - his old man's a Rolling Stone".`,

    `791 There was a young fellow who lost an eye in a farm accident.Coming from a poor family, the best his parents could manage was a home - made wooden eye to fill the void.Being self conscious he felt it unlikely he would ever find a girlfriend.Finally, after much encouragement, he decided to attend a dance.After looking over the girls in attendance, he noticed a girl who had a very large nose sitting alone.Figuring she if anyone would be understanding about his wooden eye, he decided to ask her to dance.Crossing the floor he said "Would you like to dance?" The happy girl leaped to her feet and squealed "Would I? Would I?".He shouted back at her "Big nose!! Big nose!!".`,

    `792 A guy walks into a bar carrying a giraffe.He sets the giraffe down by the door and walks up to the bartender. "Bartender, give me a whisky," he says.The bartend looks at him and says, "You know, you can't just leave that lyin' over there."`,
    ...
    `The black bear says "You've got two choices. One, I maul you to death or Two, we have sex." Troy bends over for the bear.He's sore for 2 days, but he recovers and`,
    ...
    `796 Man comes home from work to find boy next door digging big hole in lawn.Asks boy why. "Well I'm burying my goldfish Mr." Man says "I'm sorry about your fish but why do you need such a big hole?" Boy replies "Well it's inside your cat!"`,

    `797 A farmer goes out one winter morning to find that all his cows are frozen solid where they stand.While he is wondering what to to, he sees a figure approaching slowly across the fields.It is a little old lady; she looks at the cows, then works her way around the field, rubbing the nose of every cow in turn.`,
    ...
    `798 A man went into a pet shop and said "I'd like to buy a fly please".The shop keeper said "I'm sorry sir we don't do flies".`,

    `"Well there was one in the window yesterday!"`,

    `799 You can take a horse to water, but a pencil must be lead.`,

    `800 Why did the chicken cross the road ? To get to the other side.`,

    `Why did the rooster cross the road ? He was glued to the chicken.`,

    `Why was the rooser glued to the chicken ? They ran out of tape.`,

    `801 what do you call a dog with no legs Anser.a hotdog`,
    ...
    `804 A man and wife were eating in a very exclusive restaurant when a georgeous woman came up to the table, pur her arm around the man and gave him a kiss, and said 'I'll see you later.'`,
    ...
    `Just then one of their friends came in to the restaurant with a georgous woman on his arm.The wife asked 'Who's that with Bob ? and her husband replied 'Oh, thats his mistress.'`,
    ...
    `806 A snail is on the bar one Christmas, and asks the barman "Excuse me, can I have a pint of beer please?".The barman says "You WHAT?". "May I have a pint of beer, please?" repeats the snail. "Don't be so stupid, snails don't drink beer" snarls the bar man and sweeps the snail off the bar on to the floor.`,
    ...
    `807 A rabbit went into a butchers shop and said, "Got any carrots?" The butcher said, "No!" The rabbit went back to the butchers the next day and said, "Got any carrots?" The butcher said, "No!"`,

    `The rabbit went back the next day and said, "Got any carrots?" The butcher said, "No! And if you come back tomorrow and ask if I have any carrots I'll nail your ears to the ceiling!"`,

    `The rabbit went back to the butchers the next day and asked, "Got any nails?" The butcher said, "No!" The rabbit said, "In that case, have you got any carrots?"`,
    ...
    `814 A woman went to a seance and was successful in contacting her husband.`,

    `    Hi, " he said," it's me. Everything's better... sky is bluer... grass is greener`,

    `Nothing to do but eat and sleep all day." "Oh, thank goodness.You did get to Heaven."`,

    `"Heaven?. I'm a buffalo in Montana!"`,

    `815 From the deepest, darkest jungles of deepest, darkest Africa comes the cry of the Sandwich bird - "Eat me, Eat me".`,
    ...
    `819 A man walks into a greengrocers and says "Can I have a hammer please?".The`,

    `assistant says "Sorry this is a greengrocers." The man replies "That's O.K. I've got my bike outside."`,

    `820 A priest conducts a service in a church "The person who puts the most in the church collection box can choose three hymns" he says.The collection box comes back to him after being filled up and he finds that someone has donated a thousand pounds "who has donated a thousand pounds?" he asks.A women raises her hand.The priest invites her to the front and tells her to choose three hymns.Pointing at the three most handsom men in the church she says "I'll have him,him and him"`,

    `821 What's yellow and always pints north? A magnetic banana!`,

    `822 Q - How do you hide an elephant ?`,

    `    A - Paint its toenails red and stick it in a cherry tree.Q - Have you ever seen an elephant in a cherry tree ? A - See, it works!`,

    `823 Two kids were talking in the playground.The first kid says, "My mum is from Ireland and my dad is from America. That makes me an Irish-American".`,

    `The second kid says, "Well my mum is from Iceland and my dad is from Cuba.So I`,
    ...
    `825 Farmer Fred has an American farmer visiting him.The American farmer is boasting about the size of his land in the United States:`,

    `"My land is so big, that it takes me two hours to drive around it by car."`,
    ...
    `828 Bill happened by his neighbor's house one day. He saw his friend, farmer John in the`,

    `apple orchard holding his favorite, prize pig.John would patiently hold Snooks up so she could munch an apple right off the twig, then move on to the next apple and the next. "Hello, John," says Bill, "not to interfere with your pastime but whyn't ya pick Snooks a bucket of them apples...it would save time!"`,

    `"Eh'yeah, Bill, it would...but then...what's time to a pig!"`,

    `829 "He said 'I'm going to chop off the bottom of one of your trouser legs and put it in a library.' I thought 'That's a turn-up for the books."`,

    `830 A man left for a vacation to Jamaica.His wife was on a business trip and was planning to meet him there the next day.When he reached his hotel, he decided to send his wife a quick e - mail.`,
    ...
    `831 A greyhound is sitting in pub, drinking its beer when the door opens and a horse comes in.It sits down beside another horse and starts to talk of its troubles. "Same as before, Des" says the horse "I get to within a hundred feet of the winning post and I fall over".The other horse commiserates, "That happening to all of us flat racers, Red. It must some sort of disease" The dog interrupts "I can't believe it!, that's exactly what happened to me at Whitecity yesterday".`,

    `The horses look at each in surprise; "Will you look at that. A talking dog!"`,

    `832 A man sees an ad for a joke contest in his local newspaper so he sends in ten puns.He gets a letter back from the newspaper thinking he win, but no pun in ten did.`,

    `833 Why is 6am like a pigs tail ? Because it's twirly!`,

    `834 A horse walks into a bar and the bar man says, "Hey we have a whiskey named after you"!! The Horse says, "What.....Fred"!!`,

    `835 Q: how do you tell if an ant is a male ant or a female ant.A: drop it in water, if it floats it's boy-ant!`,

    `836 Q.Why can't a rope? A. Because it can knot`,

    `837 What do you call a judge with no thumbs ? Justice Fingers`,

    `838 How elephants can you get in a mini ? Two in the front and two in the back! How do you know if there's been an elephant in the fridge? There's footprints in the butter! How do you know if there's been two elephants in the fridge? There's two footprints in the butter! How do you know there's been three elephants in the fridge? There's three footprints in the butter! How do you know if there's been four elephants in the fridge? There's a mini parked outside!!`,
    ...
    `        848 A man walks into a barbers shop.He says"I want to buy a comb"."Steel one "says the barber".No I want to pay for it`,

    `849 How many mystery crime novel writers does it take to change a lightbulb ? One, but he has to give it a really good twist.`,

    `850 Tonto and the Lone Ranger are riding through the desert when they spy a small town on the horizon.Its a cold desert night and the Lone Ranger fancies a whiskey or two to warm him up so they stop into a saloon.The barman is happy to serve the Lone Ranger but refuses to serve Tonto.`,
    ...
    `There are 5 people in my family - this means that it is either my Mother, my Father, my Younger Brother Colin or ny Older Brother Ho Cha Chin.`,

    `But I think it is Colin!`,

    `854 A man goes into the doctors he says ' doctor doctor I feel like a dog' the doctor says 'sit on the couch I'll be with you in a minute' the man says 'I'm not allowed'.`,

    `855 A man went into a pet shop and said: "I would like a pet parrot for my daughter." and then the owner of the pet shop said: "sorry, this is a pet shop, we don't do swaps!"`,

    `856 Why do ducks have webbed feet ? To stamp out fires.`,

    `Why do elephants have flat feet ? To stamp out burning ducks.`,

    `857 How do you get two whales in a car ? Drive down the M4!`,
    ...
    `865 As migration approached, two elderly vultures doubted they could make the trip south, so they decided to go by airplane.When they checked their baggage, the attendant noticed that they were carrying two dead racoons. "Do you wish to check the raccoons through as luggage?" she asked. "No, thanks," replied the vultures. "They're carrion."`,

    `866 My sister is reacting very slowly.Last week trhis guy wanted to take advantage of her and before she could say she wasn't such kind of a girl. she was.`,

    `867 Why is being a test tube baby so great ? You get a womb with a view.`,

    `868 What is old, dusty and tucked away behind the bookshelf ? A : The 1974 hid'n seek champion!`,
    ...
    `872 Golfer on Par 3 tee, large pond between tee and green.He puts an old ball on the tee.`,

    `Hears a voice: "Use a new ball!" The old ball is replaced with a new one, then he takes a practice swing. "Use the old ball!!"`,

    `873 Why couldn't the Prince Potato marry the BBC correspondent? Because she was a common-tater......`,

    `874 How many boring people does it take to change a lightbulb ? One.`,

    `875 Bob recently bought a new car and is driving back home on the M1 highway.Suddenly`,

    `the music on the radio is interrupted and a special boradcast is heard "This is breaking news, there one car going the wrong way on the highway M1, drivers please be aware!" Bob looks around and says "One? There are hundreds!"`,

    `876 knock knock whos there`,
    ...
    `878 A man visiting a farm notices a three legged pig hobbeling around.Thinking it strange such an animal should be kept on a working farm, he asked the farmer`,
    ...
    `"Oh I see." said the visitor. "But why does the pig have only three legs?" "Why son...," said the farmer, "a pig like that you just don't eat all at once."`,

    `879 so there's these two talking muffins, and they're sitting in an oven.one of them looks at the other and says, "boy, it's hot in here!" and the other one says, "oh my god, it's a talking muffin!"`,

    `880 The night watchman was making his rounds and was surprised that no one was in the office except a big dog emptying wastebaskets.`,
    ...
    `The argument got louder and louder with his wife shouting about her killing her first deer.Finally, the weary voice of the man was heard admitting defeat, "Okay, lady, it's YOUR deer.`,

    `Just let me get my saddle off it..."`,

    `883 One woman had always wanted to take a bath in a tub filled with warm milk.So she called the dairyman out to measure the tub and find out how much milk she would need and how much it would cost.He began measuring and asked her, "Do you want it pasteurized?" And she said, "No, just up to my bosom would be fine."`,

    `884 A man prays to god every friday: "Oh God let me win the state lottery" ... One day a voice comes to him and says "Come on - Give me a chance! Buy a lottery ticket!"`,

    `885 What did one casket say to the other ? That you coughin'?`,

    `886 On Monday a delivery van was stolen containing files and diaries.The next day`,

    `another van was stolen, this time containing filing cabinets.The police believe it was organised crime.`,

    `887 A city feller goes to a dude ranch and arrives in the evening.Making conversation with the cow - hand, he asks "Are we going to be driving that bunch of cows over there?" "Herd" is the cowhand's reply. "Heard? Heard of what?" asks the city slicker. "Herd of COWS" replies the cow-hand. "'Course I've heard of cows," says the indignant city dweller. "There's a bunch of 'em right over there!"`,

    `888 Three men were on a boat and they wanted a smoke.They had a packet of cigarettes, but no matches.So how did they get to have their smoke ?`,

    `    Don't know?`,

    `Simple.They threw one of the cigarettes overboard and then the boat was a cigarette lighter!`,

    `889 A magician was working on a cruise ship in the Caribbean.The audience would be different each week, so the magician allowed himself to do the same tricks over and over again.There was only one problem: The captain's parrot saw the shows each week and began to understand how the magician did every trick. Once he understood he started shouting in the middle of the show: "Look, it's not the same hat" "Look, he is hiding the flowers under the table" "Hey, why are all the cards the Ace of Spades ? " The magician was furious but couldn't do anything; it was, after all, the captain's parrot. One day the ship had an accident and sank. The magician found himself on a piece of wood in the middle of the ocean with the parrot, of course. They stared at each other with hate, but did not utter a word. This went on for a day and another and another. After a week the parrot said: "OK, I give up.Where's the boat?"`,

    `890 A cocker spaniel limps into a bar and says to the bartender, "I'm looking for the man who shot my paw."`,

    `891 A man goes to see the doctor -`,

    `    Man - Doctor, Doctor I feel like a cowboy!`,

    `Doc - Mmmmmm, and how long have you felt this way ? Man - about a YEEEEEEHAAAAAAA!`,

    `892 A man in a balloon calls down to a fellow on the ground. "Where am I?", he asks. "You're in a balloon", the fellow replies. "You must be a software engineer", says the man in the balloon - "for where else could I receive such a useless, yet technically correct answer?" The fellow on the ground yells, back: "Very good guess! I am a software engineer - you must be a manager!" The startled man in the balloon admits this is true and asks how the fellow on the ground knew this. "Because you don't know where you are, or where you are going, and are still in the same situation`,

    `you were before asking for my help - but now you've somehow managed to make it my fault", the fellow replied.`,

    `893 A ship carrying blue paint has collided with a ship carrying red paint.All passengers have been marooned.`,

    `894 A ship carrying artificial limbs has sunk.All hands are reported lost.`,

    `895 What do you call a cow spying on another cow ? A steak out.`,

    `896 A linguistics professor was lecturing to his class one day. 'In English,' he said, 'A double`,

    `negative forms a positive.In some languages, though, such as Russian, a double negative is still a negative.However, there is no language wherein a double positive can form a negative.' A voice from the back of the room piped up, 'Yeah, right.'`,

    `897 What do you get if you cross a pit bull with a collie ? A dog that will chew your leg off then run for help.`,

    `898 Bob received a parrot for his birthday.The parrot was fully grown, with a`,
    ...
    `that I offended you with my language and my actions, and I ask your forgiveness.I will endeavour to correct`,
    ...
    `899 Q: How do mommy brooms and daddy brooms make baby brooms ? A : They sweep together!`,
    ...
    `901 Two men on the 9th tee tire of waiting for two women to get off the fairway.One man approaches them but before he reaches the women he does an abrupt U turn,`,

    `    and explains to his partner that one of the women is his wife and the other is`,

    `his girl friend.The second man agrees to go but also does a U turn before reaching`,

    `the ladies and explains to his partner on returning "Small world, isn't it!"`,
    ...
    `904 A scientist who thought he knew everything was going on a business trip.On the`,

    `airplane, he sat next to a lady.He asked her, "Do you want to play a game where I ask you a question and if you can't answer, you give me $5 and then you ask me a question and I give you $5 if I can't answer?"`,
    ...
    `On the next hole the Victor staid close to John offering quiet support.As John missed an even easier putt he shouted "Damn, I missed the bugger!"`,
    ...
    `911 Q: Why did the first monkey fall out of the tree ? A : Because he was dead.`,

    `    Q: Why did the second monkey fall out of the tree ?`,

    `        A : Because he was tied to the first monkey.`,

    `            Q: Why did the third monkey fall out of the tree ? A : Monkey see, monkey do.`,

    `                Q: Why did the fourth monkey fall out of the tree ? A : Peer pressure.`,

    `912 An elderly couple was on a cruise and it was really stormy.They were standing on the back of the boat watching the moon, when a wave came up and washed the old woman overboard.They searched for days and couldn't find her, so the captain sent the old man back to shore with the promise that he would notify him as soon as they found something. Three weeks went by and finally the old man got a fax from the boat. It read: "Sir, sorry to inform you, we found your wife dead at the bottom of the ocean. We hauled her up to the deck`,

    `and attached to her rear was an oyster and in it was a pearl worth $50, 000 ...please advise" The old man faxed back: "Send me the pearl and re - bait the trap"`,
    ...
    `914 An elderly couple had dinner at another couple's house, and after eating, the wives left the table and went into the kitchen.`,
    ...
    `945 A wife went to the police station with her next - door neighbor to report her husband was missing.The policeman asked for a description.`,
    ...
    `948 What is the difference between a duck ? One of its legs are both the same!`,

    `949 Q: What's yellow and can't waterski ? A : A bulldozer.`,

    `950 What do you call a dry parrot ? Polyunsaturated`,

    `951 The court was investigating an accident`,

    `Judge: What gear were you in at the moment of the impact ? A : Gucci sweats and Reeboks.`,

    `952 Chap goes to the doctor, who examines him and says "Hmmm, OK, go over to the window and stick your tongue out". "But" protests the chap "I've only got a sore knee!". "I know" says the doctor "but I hate that bloke across the road".`,
    ...
    `955 husband tells doctor, 'Doctor my wife thinks she's a four poster bed.' doctor replies, 'In that case, she needs to go into care.'`,

    `husband responds, 'But what will I sleep on'`,

    `956 Q.How do you know that you have slept like a log ? A.You wake up in the fireplace.`,

    `957 "I don ́t care whose son you are. I don ́t want you walking on the water here where I am fishing and scaring the fishes away."`,

    `958 Q.Why do squirrels swim on their backs ? A.To keep their nuts dry.`,

    `959 Stopped at a friend's house the other day and found him stalking around with a fly swatter.`,
    ...
    `962 It's a contest. There's three contestants.The object is they say a phrase and have to fill in the blank and spell the word.First contestant - "old macdonald had a _______" First contestant says house H O U S E.Wrong!!!!`,

    `Second contestant "old macdonald had a _______".Yard Y A R D.Wrong!!!!`,

    `Third contestant "old macdonald had a ________" farm, EIEIO.`,

    `963 A dog called "Rufus Jagger" walks into a bank.The Teller say's "Hello my name is Sally Whack, how can I help you". The dog puts a keyring with a little toy elephant attached to it onto the counter and says "I'd like a loan please". Sally Whack, baffeled by what's happening picks up the keyring and calls her manager, she explains the situation and show's her manager the keyring. The manager say's "It's a nick nack Sally Whack give the dog a loan his old man's a rolling stone".`,

    `964 The preacher was wired for sound with a lapel mike, and as he preached, he moved briskly about the platform, jerking the mike cord as he went.Then he moved to one side, getting wound up in the cord and nearly`,
    ...
    `974 The old man was sitting on the bench starring at a teen - age boy with his spiked, yellow, red, green and orange hair.the kid says "what's the matter old man..haven't you ever done anything wild in your days??" "YUP, said the old man, made love to a parrot once, thought you might be my son!"`,

    `975 What do you call a man with a car on his head ? Jack`,

    `976 A master French thief decides to pull off a huge job at the Louvre, stealing several`,

    `valuable paintings.However, he was stopped and arrested just a few blocks away from the museum at a gas station.When asked how he could pull off such a heist and yet get arrested so easily, he responded,`,
    ...
    `978 A guy is waiting to cross the traffic lights as a pedestrian, when another guy comes up and puts his hand in his pocket. "What do you think your doin?" the guy asks. "Just lookin for a light" the guy says.`,

    `"Well why don't you just ask??'" says the first guy`,

    `"I don't like talkin to strangers!!'" comes the reply.`,

    `979 What do you get when you cross a pitt bull with lassie ? A dog that bites your leg then goes and gets help`,
    ...
    `982 It's spring time and a family of moles decides it's time to come out of hibernation.The daddy mole sticks his head out of the ground, smells the air and says, "mmmm, smells like bacon." The momma mole sticks her head out, smells the air, and says, "mmmmm, smells like pancakes." The baby mole tries to stick his head out, but there isn't enough room, so he smells the air and says, "mmmm, smells like molasses."`,

    `983 A bus station is where a bus stops.A train station is where a train stops.On my desk I have a work station.`,
    ...
    `987 did you hear about the boy whos nose grew 11inches ? he thought it might turn into a`,
    ...
    `990 What do you call a Skoda with a sunroof ? A skip.`,

    `991 Why do Skodas have two exhaust pipes ? Wheelbarrow.`,

    `992 Doctor Bob had slept with one of his patients and had felt guilty all day long.`,
    ...
    `993 How many religious education teacher's does it take to screw in a light bulb? One, and their God of choice.`,

    `994 Why did the bird with one eye cross the road To get two birdseye factory`,

    `995 Two bugs go out of a concert.The smaller one asks: Shall we walk home or take a dog ?`,

    `    996 A guy walks out to his porch one day and sees a snail crawling across the step.He`,

    `picks up the snail and throws it across the lawn, into the street.Two years later he hears a soft knocking on the door, he goes to the door and opens it.The snail, looking up from the ground at him, says "Well what was *that* about?"`,

    `997 What do you call a sheep with no head or legs ? A cloud.`,

    `998 I am now on a seafood diet! I see food and I eat it!!`,
    ...
    `1005 Did you hear about the man who lived in a tyre ? He had a puncture so now he lives in a`,
    ...
    `1008 As a teacher I was trying to get my students to understand what a "pun" was.I gave`,
    ...
    `The next morning he asks his wife to check if the pigs are breeding, she tell him they aren't. Wearily, he goes out and "teaches" them all over again.`,
    ...
    `1011 A man decides to take the opportunity while his wife is away to paint the toilet seat.`,

    `After he finished, he went to the kitchen to raid the fridge.The wife comes home sooner than expected, and heads to the bathroom, sits down and gets the toilet seat stuck to her rear.In a panic, she shouts to her husband to drive her to the doctor.She puts on a large overcoat to cover the stuck seat, and off they go.When they get to the doctors office, the man lifts his wifeÌs coat to show their predicament.`,
    ...
    `1015 Q.What is Big, Red & eats Rocks ? A.A big red rock eater!`,
    ...
    `1017 Matt: I got a set of golf clubs for my wife.Ben: Nice trade.`,

    `1018 Two guys were walking on the street when one of them says: "I've realized that my wife is an angel."`,

    `"Mine isn't human, either", said the second.`,

    `1019 Two nuns were travelling through Europe in their car.They get to Transylvania and are stopped at a traffic light.Suddenly, a`,
    ...
    `1022 Q: Why did the Koala fall out of the tree.A: Because it was dead!`,

    `Q: Why did the Kookaburra fall out of the tree A: Because it was hit by a falling dead Koala`,
    ...
    `voice tells him, "Quit your job, sell your house, take your money, go to Vegas." Again the man ignores the voice, though he is very troubled by`,
    ...
    `money on 17." Nervously, the man cashes in his money for chips and then puts them all on 17.`,
    ...
    `1035 if a fly and a flee pass each other what time is it ? Fly past flee!`,
